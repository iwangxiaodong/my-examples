...
package com.wangxiaodong.android.view;
...
//for wangxiaodong 2014-11-10
// implementation 'com.caverock:androidsvg:1.3'
        /* Added res/values/attrs.xml:
 ...
 * <p/>
 * In its present form it has one significant limitation.  It uses the {@link com.caverock.androidsvg.SVG#renderToPicture()}
...
public class SVGImageView extends ImageView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        //for wangxiaodong 2014-11-10
        int[] resourceIds = ResourceCommon.getResourceIdArray(getContext().getPackageName(), "styleable", "SVGImageView");
        TypedArray a = getContext().getTheme()
                .obtainStyledAttributes(attrs, resourceIds, defStyle, 0);
        int svgResourceId = ResourceCommon.getStyleableId(getContext(), "SVGImageView_svg");

        try {
            int resourceId = a.getResourceId(svgResourceId, -1);
            if (resourceId != -1) {
                setImageResource(resourceId);
                return;
            }

            String url = a.getString(svgResourceId);
            if (url != null) {
